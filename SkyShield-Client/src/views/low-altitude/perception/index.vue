<template>
  <div class="app-container perception-page">
    <div class="page-head">
      ...
      <el-button type="primary" icon="Refresh" @click="refreshTime = new Date().toLocaleString()">刷新态势</el-button>
    </div>
          ...
          <el-table :data="sources" border>
            ...
            <el-table-column prop="status" label="状态" width="110">
              <template #default="{ row }">
                <el-tag :type="row.status === '在线' ? 'success' : 'warning'">{{ row.status }}</el-tag>
              </template>
            </el-table-column>
...
<script setup name="ThreatPerception">
